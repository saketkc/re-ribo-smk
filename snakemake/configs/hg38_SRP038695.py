...
RAWDATA_DIR = '/staging/as/skchoudh/re-ribo-datasets/samples_to_process/SRP038695'

## Output directory
OUT_DIR = '/staging/as/skchoudh/re-ribo-analysis/hg38/SRP038695'  #_alignEndToEnd'
