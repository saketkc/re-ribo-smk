...
RAWDATA_DIR = '/staging/as/skchoudh/re-ribo-datasets/samples_to_process/SRP049168_human'

## Output directory
OUT_DIR = '/staging/as/skchoudh/re-ribo-analysis/hg38/SRP049168_human'  #_alignEndToEnd'
